...
function createMaster(e) {
    ...
    let data = { "proceso": "master_fg_zf_create", "user_id": user_id.innerHTML, "serial": `${serialsArray}`, "lower_gr_date": `${lower_gr_date}` };
    axios({
        method: 'post',
        url: "/master_request_zf_create",
        headers: {
            'Content-Type': 'application/json'
        },
        data: JSON.stringify(data)
